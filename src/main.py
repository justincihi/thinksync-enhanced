...
def create_session():
    try:
        ...
        if request.content_type and 'multipart/form-data' in request.content_type:
            # Handle file upload
            client_name = request.form.get('clientName', 'Test Client')
            therapy_type = request.form.get('therapyType', 'CBT')
            summary_format = request.form.get('summaryFormat', 'SOAP')
            ...
            if 'audio_file' in request.files:
                ...
                if audio_file.filename != '':
                    ...
                    # For now, we'll generate analysis without actual audio processing
                ...
                # No file uploaded, generate demo analysis
                result = generate_comprehensive_analysis(client_name, therapy_type, summary_format)
        else:
